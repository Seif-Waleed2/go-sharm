...
modifyButtons.forEach((btn) => {
  btn.addEventListener("click", function () {
    ...
    const bookingTitle = bookingCard.querySelector(
...
viewDetailsButtons.forEach((btn) => {
  btn.addEventListener("click", function () {
    ...
    const bookingDate = bookingCard
      .querySelector(".booking-date")
      .textContent.trim();
    const bookingPrice = bookingCard.querySelector(
      ".booking-price .price",
    ).textContent;
...
const languageChangeBtn = document.querySelectorAll(
  ".preferences-settings .btn-setting-action",
)[0];
const currencyChangeBtn = document.querySelectorAll(
  ".preferences-settings .btn-setting-action",
)[1];
