...
export default function PlanResult() {
  ...
  if (!plan) {
    return <Navigate to="/ai-planner" replace />;
  }
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="relative mb-6 h-56 overflow-hidden rounded-2xl">
            ...
            <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/60 to-transparent p-6">
              <h1 className="text-2xl font-extrabold text-white sm:text-3xl">
                Your vacation in sharm elsheikh for {totalDays} day{totalDays > 1 ? 's' : ''}
              </h1>
            </div>
          </div>
        ...
        <div className="hidden overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800 lg:block">
