...
function MonthGrid({ year, month, start, end, onSelect }) {
  ...
  return (
    <div>
      <p className="mb-3 text-center font-semibold text-ink dark:text-white">
                ...
                selectedStart || selectedEnd
                  ...
                  : inRange
                    ...
                    : isPast
                      ...
                      : 'bg-slate-50 text-ink hover:bg-brand-50 dark:bg-white/5 dark:text-white dark:hover:bg-white/10'
              }`}
            >
              {day.getDate()}
            </button>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div>
          <button
            type="button"
            onClick={() => nextMonth(-1)}
            className="mb-2 rounded-full p-1 hover:bg-slate-100 dark:hover:bg-white/10"
          >
            <ChevronLeft size={18} />
          </button>
        ...
        <div>
          <button
            type="button"
            onClick={() => nextMonth(1)}
            className="mb-2 ml-auto block rounded-full p-1 hover:bg-slate-100 dark:hover:bg-white/10"
          >
